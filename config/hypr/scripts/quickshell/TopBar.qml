    ...
    delegate: Component {
        PanelWindow {
            ...
            Item {
                ...
                Rectangle {
                    id: cavaBox
                    color: Qt.rgba(mocha.base.r, mocha.base.g, mocha.base.b, 0.55)
                    radius: barWindow.s(14)
                    border.width: 1
                    border.color: Qt.rgba(mocha.text.r, mocha.text.g, mocha.text.b, 0.05)
                    y: (parent.height - barWindow.barHeight) / 2
                    height: barWindow.barHeight
                    width: barWindow.s(110)

                    property real defaultX: mediaBox.x + mediaBox.width + (mediaBox.width > 0 ? barWindow.s(4) : 0)
                    x: defaultX
                    visible: opacity > 0
                    opacity: 1.0
                    ...
                    Process {
                        running: true
                        command: ["/usr/bin/cava", "-p", "/home/amir/.config/cava/config_bar"]
                        stdout: SplitParser {
                            onRead: function(line) {
                                let parts = line.split(";");
                                if (parts.length < 12) return;
                                let arr = [];
                                for (let i = 0; i < 12; i++) arr.push(parseInt(parts[i]) || 0);
                                cavaBox.bars = arr;
                            }
                        }
                    }
                    ...
                    Row {
                        ...
                        Repeater {
                            ...
                            delegate: Rectangle {
                                width: barWindow.s(4)
                                height: Math.max(barWindow.s(2), (cavaBox.bars[index] / 100.0) * barWindow.s(22))
                ...
                Rectangle {
                    ...
                    RowLayout {
                        ...
                        ColumnLayout {
                            spacing: -2
                            Text { text: barWindow.timeStr; Layout.alignment: Qt.AlignLeft; font.family: "JetBrains Mono"; font.pixelSize: barWindow.s(16); font.weight: Font.Black; color: mocha.text }
                        ...
                        Row {
                            ...
                            Rectangle {
                                ...
                                Rectangle {
                                    anchors.fill: parent
                                    radius: barWindow.s(10)
                                    opacity: barWindow.showEthernet ? (barWindow.ethStatus === "Connected" ? 0.45 : 0.0) : (barWindow.isWifiOn ? 0.45 : 0.0)
                                    Behavior on opacity { NumberAnimation { duration: 300 } }
                                    gradient: Gradient {
                                ...
                                Row { 
                                    ...
                                    Text { 
                                        ...
                                        color: barWindow.showEthernet ? (barWindow.ethStatus === "Connected" ? mocha.text : mocha.subtext0) : (barWindow.isWifiOn ? mocha.text : mocha.subtext0)
                                    }
                                    Text { 
                                        id: wifiText
                                        anchors.verticalCenter: parent.verticalCenter
                            ...
                            Rectangle {
                                ...
                                Rectangle {
                                    anchors.fill: parent
                                    radius: barWindow.s(10)
                                    opacity: barWindow.isBtOn ? 0.45 : 0.0
                                    Behavior on opacity { NumberAnimation { duration: 300 } }
                                    gradient: Gradient {
                                        orientation: Gradient.Horizontal
                                ...
                                Row { 
                                    ...
                                    anchors.leftMargin: barWindow.s(12)
                                    spacing: barWindow.s(8)
                                    Text { anchors.verticalCenter: parent.verticalCenter; text: barWindow.btIcon; font.family: "Iosevka Nerd Font"; font.pixelSize: barWindow.s(16); color: barWindow.isBtOn ? mocha.text : mocha.subtext0 }
                                    Text { 
                                        id: btText
                                        anchors.verticalCenter: parent.verticalCenter
                            ...
                            Rectangle {
                                ...
                                Rectangle {
                                    anchors.fill: parent
                                    radius: barWindow.s(10)
                                    opacity: barWindow.isSoundActive ? 0.45 : 0.0
                                    Behavior on opacity { NumberAnimation { duration: 300 } }
                                    gradient: Gradient {
                                        orientation: Gradient.Horizontal
                                ...
                                Row { 
                                    ...
                                    Text { 
                                        ...
                                        color: barWindow.isSoundActive ? mocha.text : mocha.subtext0
                                    }
                                    Text { 
                                        anchors.verticalCenter: parent.verticalCenter
                                        text: barWindow.volPercent; 
                                        font.family: "JetBrains Mono"; font.pixelSize: barWindow.s(13); font.weight: Font.Black; 
                                        color: barWindow.isSoundActive ? mocha.text : mocha.text;
                                    }
                                }
                            ...
                            Rectangle {
                                ...
                                Rectangle {
                                    ...
                                    gradient: Gradient {
                                        orientation: Gradient.Horizontal
                                        GradientStop { position: 0.0; color: barWindow.isDesktop ? mocha.peach : barWindow.batDynamicColor; Behavior on color { ColorAnimation { duration: 300 } } }
                                        GradientStop { position: 1.0; color: barWindow.isDesktop ? Qt.lighter(mocha.peach, 1.3) : Qt.lighter(barWindow.batDynamicColor, 1.3); Behavior on color { ColorAnimation { duration: 300 } } }
                                    }
                                }
